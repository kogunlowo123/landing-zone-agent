"""Landing Zone Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with Landing Zone Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with Landing Zone Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with Landing Zone Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with Landing Zone Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with Landing Zone Agent."""
