...
[![CI](https://github.com/kogunlowo123/landing-zone-agent/actions/workflows/ci.yml/badge.svg)](https://github.com/kogunlowo123/landing-zone-agent/actions/workflows/ci.yml)
[![Python 3.11+](https://img.shields.io/badge/python-3.11+-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)

> **Category**: Cloud Engineering | **Cloud**: MULTI-CLOUD | **LLM**: gpt-4o

Cloud landing zone architect that designs and deploys organizational account structures, implements guardrails, configures networking topology, sets up centralized logging and security, and manages multi-account governance.
...
| Tool | Description |
|------|-------------|
| `design_architecture` | Design cloud architecture for Landing Zone Agent |
...
│   │   ├── landing_zone_agent_agent.py  # Main agent with domain tools
